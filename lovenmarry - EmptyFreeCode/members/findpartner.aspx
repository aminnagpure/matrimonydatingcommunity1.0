<%@ Page Language="VB" MasterPageFile="~/members/MasterPage.master" AutoEventWireup="false"
    CodeFile="findpartner.aspx.vb" Inherits="members_findpartner" Title="Partner Search"   %>
<asp:Content ContentPlaceHolderID="headContent" ID="hh" runat="server">
<style>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    &nbsp;<div id="body">
                    ...
                    <td align="left" style="height: 662px">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="dpage1" runat="server" Width="95px">
                                    ...
                                    -<asp:DropDownList ID="dpage2" runat="server" Width="95px">
                                        <asp:ListItem>18</asp:ListItem>
                                        <asp:ListItem>19</asp:ListItem>
                                        <asp:ListItem>20</asp:ListItem>
                                        <asp:ListItem>21</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="dpheight1" runat="server" Width="95px">
                                        <asp:ListItem Value="">-</asp:ListItem>
                                    ...
                                    -<asp:DropDownList ID="dpheight2" runat="server" Width="95px">
                                        <asp:ListItem Value="">-</asp:ListItem>
                                        <asp:ListItem Value="1">4.10(1.47 mts)</asp:ListItem>
                                        <asp:ListItem Value="2">4.11(1.50 mts)</asp:ListItem>
                                        <asp:ListItem Value="3">5.0(1.52 mts)</asp:ListItem>
     ...
     <div id="searchresults" runat="server">
                <asp:TextBox
                    ID="txtjointype" runat="server" Width="557px" Visible="false"></asp:TextBox><br />
                <br />
                ...
                <asp:GridView ID="gridview1" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    runat="server" Width="100%"  GridLines="Both"
                    Font-Size="Small" DataSourceID="ObjectDataSource1" CssClass="grid" >
                   
                    <AlternatingRowStyle CssClass="gridAlternetRow" />
                   
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <table cellpadding="5" cellspacing="5" style="width: 100%; text-align: left; vertical-align: top;">
                                    <tr>
                                        <td style="text-align: left; vertical-align: top;">
                                            <a href="viewprofile.aspx?pid=<%# Eval("pid") %>">
                                                <asp:Image ID="img" runat="server" BorderWidth="5px" Width="70" /></a>
                                        </td>
                                        <td style="text-align: left; vertical-align: top;">
