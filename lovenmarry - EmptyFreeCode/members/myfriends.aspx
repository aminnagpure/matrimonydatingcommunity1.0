<%@ Page Language="VB" MasterPageFile="~/members/MasterPage.master" AutoEventWireup="false" CodeFile="myfriends.aspx.vb" Inherits="members_myfriends" title="My Friends" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div id="body">    <table style="width: 90%">
        <tr>
        ...
        <asp:TemplateField>
        <ItemTemplate>
       <a href="viewprofile.aspx?pid=<%# Eval("pid") %>"><%#Eval("fname")%></a><br />          
        ...
        <asp:Image ID="img" runat="server" Height="80px" Width="100px" /></a>
         ...
         <asp:TemplateField>
        <ItemTemplate>
        <a href='delfriend.aspx?id=<%# Eval("fidreq")%>'>
        ...
        Cancel Acceptance
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                    SelectMethod="GetProductsPaged" TypeName="clsMyFriends" EnablePaging="True">
                    <SelectParameters>
