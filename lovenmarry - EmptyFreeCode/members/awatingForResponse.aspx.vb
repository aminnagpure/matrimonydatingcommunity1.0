...
Partial Class members_awatingForResponse
    ...
    Sub loadQuery()
        ...
        TextBox2.Text = " profile.pid in(Select IntrestedIn from User_Interest WHere candiid=" & Session("pid") & " and UserResponse='P')"
    ...
    Protected Sub gridview1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridview1.RowCommand
        If e.CommandName = "D" Then
            UpdateInterest(e.CommandArgument)
        End If
    End Sub
    Sub UpdateInterest(ByVal pid As String)
        Dim cmd As New SqlCommand

        cmd.CommandText = "Delete_Interest"
