<%@ Page Language="VB" MasterPageFile="~/moderators/MasterPage.master" AutoEventWireup="false" CodeFile="highestreferer.aspx.vb" Inherits="moderators_highestreferer" title="Top Earners" %>
...
<asp:Label ID="label1" runat="server">
   ...
   <asp:GridView ID="gridViewPublishers" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <%#Eval("countryname")%>, <%#Eval("state")%>, <%#Eval("cityname")%>
        ...
        <asp:Image ID="img" runat="server" Height="80px" Width="100px" /></a>
            ...
            <br />
            <a href="membershemade.aspx?pid=<%# Eval("mid")%>&pstatus=pending">Members he Referd</a>
            </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    ...
    <a href="members/affprogram.aspx"> Check Program Details</a>
        ...
        <asp:TextBox ID="TextBox1" runat="server" Visible="False">r1.pstatus=&#39;Pending&#39;</asp:TextBox>
