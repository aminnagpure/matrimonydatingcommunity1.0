...
Partial Class moderators_findpartner
    ...
    Function makequery() As String
        ...
        If txtemail.Text.Trim <> "" Then
            If EmailSearch.Checked Then
                sqlEmail = " and email ='" & txtemail.Text.Trim & "'"
            Else
                sqlEmail = " and email like '%" & txtemail.Text.Trim & "%'"
            End If
        End If
        If txtName.Text.Trim <> "" Then
            sqlName = " And fname like '%" & txtName.Text.Trim & "%' "
        End If
        makequery = sqlcountry & sqlstate & sqlpincode & sqlgender & sqlrace & sqlreligion & sqlmarital & sqlstarsign & sqlheight & sqlage & sqlonline & sqlchkphoto & sqlcity & sqlchkphoto & sqlEmail & sqlName
