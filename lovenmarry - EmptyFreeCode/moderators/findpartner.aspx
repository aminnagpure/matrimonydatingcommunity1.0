<%@ Page Language="VB" MasterPageFile="~/moderators/MasterPage.master" AutoEventWireup="false"
    CodeFile="findpartner.aspx.vb" Inherits="moderators_findpartner" Title="Partner Search" %>
                    ...
                    <td align="left" style="height: 571px">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="dpage1" runat="server" Width="93px">
                                    ...
                                    -<asp:DropDownList ID="dpage2" runat="server"  Width="90px">
                                        <asp:ListItem>18</asp:ListItem>
                                        <asp:ListItem>19</asp:ListItem>
                                        <asp:ListItem>20</asp:ListItem>
                                        <asp:ListItem>21</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="dpheight1" runat="server"  Width="111px">
                                        <asp:ListItem Value="">-</asp:ListItem>
                                    ...
                                    -<asp:DropDownList ID="dpheight2" runat="server"  Width="111px">
                                        <asp:ListItem Value="">-</asp:ListItem>
                                        <asp:ListItem Value="1">4.10(1.47 mts)</asp:ListItem>
                                        <asp:ListItem Value="2">4.11(1.50 mts)</asp:ListItem>
                                        <asp:ListItem Value="3">5.0(1.52 mts)</asp:ListItem>
                           ...
                           <tr>
                                ...
                                <td>
                                    <asp:CheckBox runat="server" ID="EmailSearch" Text="Search Exact Email" Checked="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtemail" runat="server"></asp:TextBox>(Search By Email ID)
                                </td>
                            </tr>
                            <tr>
                                <td>
                                            ...
                                            <table style="width: 100%; text-align: left; vertical-align: top;">
                                                <tr>
                                                    <td style="width: 200px; text-align: left; vertical-align: top;">
                                                        ...
                                                        Gender:<%# Eval("gender") %><br />Purpose:<%# Eval("purpose") %><br /><%#Eval("countryname")%><br /><%#Eval("state")%><br /><%# Eval("cityname") %><br /><%# Eval("ethnic") %><%# Eval("religion") %><%#Eval("caste")%></td>
