<%@ Page Language="VB" MasterPageFile="~/moderators/MasterPage.master" AutoEventWireup="false"
    CodeFile="waitforapprove.aspx.vb" Inherits="moderators_waitforapprove" Title="Untitled Page" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            CellPadding="4" EmptyDataText="No records found" Font-Size="Medium" ForeColor="#333333"
                            GridLines="None" Width="100%" DataSourceID="ObjectDataSource1">
