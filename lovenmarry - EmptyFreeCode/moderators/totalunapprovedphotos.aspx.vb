...
Partial Class moderators_totalunapprovedphotos
    ...
    Function makequery() As String
        makequery = "get_UnApprovePhoto" '" select photoid,photoname,pid from photo where active='N' order by uploaddate desc"
    End Function
