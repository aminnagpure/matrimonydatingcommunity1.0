<%@ Page Language="VB" MasterPageFile="~/moderators/MasterPage.master" AutoEventWireup="false"
    CodeFile="todaysRegmem.aspx.vb" Inherits="moderators_todaysRegmem" Title="Untitled Page" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                            Width="90%" CellPadding="5" EmptyDataText="No records found" GridLines="None"
                            Font-Size="Medium" DataSourceID="ObjectDataSource1">
